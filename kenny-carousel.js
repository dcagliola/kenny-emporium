...
class KennyCarousel extends RadioBehaviors(LitElement) {
  static get styles() {
    return [
      css`
        :host {
  ...
  static get properties() {
    return {
      ...
      noPrevNext: { type: Boolean, attribute: "no-prev-next" },
...
globalThis.customElements.define(KennyCarousel.tag, KennyCarousel);
export { KennyCarousel };
